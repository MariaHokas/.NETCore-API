...
namespace MyFirstCoreApi.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.Kirjautuminen'. Please see the warning messages.
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-35CADGH\\SQLEMA;Database=Northwind;Trusted_Connection=True;");
            }
        }
